...
export const getUrl = {
  ...
  "/top_rated": () => `${API_HOSTNAME}movie/top_rated?&${API_KEY}&page=1`,
  "/upcoming": () => `${API_HOSTNAME}movie/upcoming?&${API_KEY}&page=1`,
  "/popular": () => `${API_HOSTNAME}movie/popular?&${API_KEY}&page=1`,
  ...
  "/filter": options =>
    `${API_HOSTNAME}discover/movie?&${API_KEY}&language=en-US&sort_by=${options.sortBy}&include_adult=false&include_video=false&page=1&with_genres=${options.genres}`
};
